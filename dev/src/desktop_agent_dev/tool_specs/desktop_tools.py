    ...
    registry.register(
        ToolSpec(
            ...
            description=(
                ...
                "Returns: a normalized observation payload containing active_window, windows, cursor, tree_nodes, metadata, and screenshot references. Successful responses always include error: null and the success path exposes screenshot_path, screenshot_id, and screenshot_handle.\n"
            ...
            result_description="Returns a normalized observation payload with active_window, windows, cursor, tree_nodes, metadata, and screenshot references.",
