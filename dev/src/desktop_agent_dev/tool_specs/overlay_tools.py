...
def register_overlay_tools(registry: ToolRegistry, services: Any) -> None:
    def overlay_state() -> dict[str, Any]:
        ...
        payload: dict[str, Any] = {
            ...
            "cursor_size": snapshot.cursor_size,
            "user_cursor_size": snapshot.user_cursor_size,
            ...
            "interruption_state": snapshot.interruption_state,
            "window_state": snapshot.metadata.get("window_state", "normal"),
    ...
    registry.register(
        ToolSpec(
            ...
            result_description="Read-only overlay snapshot with visibility, cursor position, display and DPI context, lifecycle and interruption states, trail, metadata, and optional motion-state data.",
            input_examples=[{}],
